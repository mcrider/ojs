...
{if $smarty.foreach.authors.first}{$author->getLastName()|escape}, {$author->getLocalizedFirstName()|escape}{else}{$author->getLocalizedFullName()|escape}{/if}{if $i==$authorCount-2}, & {elseif $i lt $authorCount-1}, {else}.{/if}
{/foreach}
