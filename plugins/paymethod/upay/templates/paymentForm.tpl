{**
 * plugins/paymethod/upay/templates/paymentForm.tpl
 *
 * Copyright (c) 2006-2009 Gunther Eysenbach, Juan Pablo Alperin
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * Form for submitting a uPay payment
 *}
{strip}
{assign var="pageTitle" value="plugins.paymethod.upay"}
{include file="common/header.tpl"}
{/strip}

<p>{translate key="plugins.paymethod.upay.warning"}</p>
<form action="{$upayFormUrl}" id="upayPaymentForm" method="post" style="margin-bottom: 0px;">
	{include file="common/formErrors.tpl"}
	{if $params.item_name}
	<table class="data" width="100%">
		<tr>
			<td class="label" width="20%">{translate key="plugins.paymethod.upay.purchase.title"}</td>
	...
	<table class="data" width="100%">
		<tr>
			<td class="label" width="20%">{translate key="plugins.paymethod.upay.purchase.fee"}</td>
