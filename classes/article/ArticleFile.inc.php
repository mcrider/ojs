...
/* File type IDs */
define('ARTICLE_FILE_USE_CASE_SUBMISSION', 0x000001);
define('ARTICLE_FILE_USE_CASE_REVIEW',     0x000002);
define('ARTICLE_FILE_USE_CASE_EDITOR',     0x000003);
define('ARTICLE_FILE_USE_CASE_COPYEDIT',   0x000004);
define('ARTICLE_FILE_USE_CASE_LAYOUT',     0x000005);
define('ARTICLE_FILE_USE_CASE_SUPP',       0x000006);
define('ARTICLE_FILE_USE_CASE_PUBLIC',     0x000007);
define('ARTICLE_FILE_USE_CASE_NOTE',       0x000008);
define('ARTICLE_FILE_USE_CASE_ATTACHMENT', 0x000009);
